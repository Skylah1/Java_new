...
public class InquiryPanel extends BasicPanel {
	...
	private JRadioButton num1 = new JRadioButton("다음달 예상 수입/지출 금액 조회", true); // 라디오 버튼
	private JRadioButton num2 = new JRadioButton("이번달 예상 수입/지출 금액 조회");
	private JRadioButton chart1 = new JRadioButton("월 별 예상 수입/지출 금액 조회"); // 라디오 버튼
	private JRadioButton chart2 = new JRadioButton("카테고리별 예상 수입/지출 금액 조회");
